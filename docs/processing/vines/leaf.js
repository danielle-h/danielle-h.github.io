/**
 * sketch for showing a growing leaf.
 *
 * Copyright 2022 Danielle Honigstein. Free for commercial and personal use with attribution.
 * Code for drawing leaf adapted from https://openprocessing.org/sketch/7743/#
 */
class Leaf {
    ...
    draw() {
        ...
        if (this.currScale <= this.maxScale) {
            ...
            // make the pointy end of the leaf vary on the x axis (so the leaf gets longer or shorter) 
            //AND vary the y axis of the control points by the same amount. It should be possible to have 
            //'normal' leaves, very short fat ones and very long thin ones.
            bezierVertex(
                10,
                -15,
                40 + this.pointShift,
